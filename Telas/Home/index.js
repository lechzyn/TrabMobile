...
export default function Home(props){
    ...
    return(
        <View style={Styles.container}>
            ...
            <TouchableOpacity style={Styles.buttonHome} activeOpacity={0.7} onPress={AbrirMedico}>
                <Text style={Styles.buttonText}>Cadastro de Médico</Text>
            </TouchableOpacity>
            <TouchableOpacity style={Styles.buttonHome} activeOpacity={0.7} onPress={AbrirUsuario}>
